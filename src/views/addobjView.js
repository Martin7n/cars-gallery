        ...
        <form @submit=${(e) => submitHandler(e)}
            action="javascript:void(0);" method="" class="w-full md:w-4/5 xl:w-1/2 p-1 flex flex-col items-center mx-auto">
                    ...
                    <div class="w-full flex justify-center py-4">
                        <img
                            id="preview"
                            class="max-w-[50vw] max-h-[50vh] object-contain rounded shadow"
...
function loadPreview(event) {
  ...
  function updatePreviewFromUrl(event){
        ...
        preview.src = "https://placehold.co/400x400?text=Preview";
    }

  }


const imageUpload = `<div class="w-full flex flex-col items-center">
