...
const template= (ctx) => html`<div class="contain py-16">
  <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
    ...
    <form autocomplete="off">
      ...
      <div class="mt-4">
        <button type="submit" class="block w-full py-2 text-center text-gray bg-teal-500 border border-teal-500 rounded hover:bg-transparent hover:text-teal-500 transition uppercase font-roboto font-medium">Register</button>
        <div class="flex gap-2 pt-5">
          <p class="text-gray-400 text-sm">Already have an account?</p><a class="text-gray-600 text-sm underline"
